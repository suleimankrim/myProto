...
const CardExperience: FC<CardExperienceProps> = () => {
  return (
    <div className="w-[400px] opacity-80 snap-center shadow-lg hover:opacity-100 h-[500px] bg-gray-100 rounded-md ">
      <div className="w-[400px] flex flex-col items-center mt-11">
        ...
        <div className="text-xl text-gray-700 tracking-[6px]">
          Enhanced Excel
        </div>
        ...
        <div className="text-sm text-gray-400">started July 2023</div>
      </div>
      <ul className="p-3 text-sm space-y-2 text-gray-500 list-disc list-inside">
        <li>
          building un enhanced version of excel to improve grading procedure.
        </li>
        <li>
